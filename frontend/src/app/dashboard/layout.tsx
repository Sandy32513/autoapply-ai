...
export default function DashboardLayout({
  ...
  const navItems = [
    { href: '/dashboard', label: 'Home', icon: 'M3 12l2-2m0 0l-2-2m2 2l2-2M9 21V9m0 10a3 3 0 01-3 3 0 01-.017-1.998A3 3 0 0114.016 17h.984A3 3 0 0118 20a3 3 0 01-3 3 0 01-1-5.98V12m0 9l-2-2m2 2l2-2' },
